...
* [rlgl](https://github.com/raysan5/raylib/blob/master/src/rlgl.h) and [raymath](https://github.com/raysan5/raylib/blob/master/src/raymath.h) submodules support.

# :.Compatibility.:
__Raylib Forever__ webpage was best tested with *Chrome 80* and [Electron](https://electronjs.org/), which is used to develop it.  
